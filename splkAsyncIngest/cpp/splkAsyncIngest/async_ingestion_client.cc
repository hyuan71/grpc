...
class GreeterClient {
  public:
    ...
    void AsyncCompleteRpc() {
        ...
        long long counterSuc = 0;
        long long counterFail = 0;
        ...
        while (cq_.Next(&got_tag, &ok)) {
            ...
            if(counterSuc % 100 == 0) {
                ...
                //fprintf(stderr, "yh101.01: time taken : %ld ms, eps is %lld \n" , ms, 1000* counterSuc / ms);
...
int main(int argc, char** argv) {
    ...
    GreeterClient greeter(grpc::CreateChannel(
            des, grpc::InsecureChannelCredentials()));
